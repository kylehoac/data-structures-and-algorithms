...
E.g. [4,2,7,5,9,2] -> 9
------------------------------------------------------------------------------------------------ */
const maxInArray = (arr) => arr.reduce((max,cur) => Math.max(max,cur));
...
const hasChildrenValues = (arr, character) => Object.values(arr.reduce((acc,cur) => cur.name === character ? acc = cur : acc, {}))[2] instanceof Array
/* ------------------------------------------------------------------------------------------------
